	...
	float var_c)
{
    ...
    const float var_1 = 3.0;
    bool var_2;
    const float var_3 = 2.0;
    float var_4;
    const float var_5 = 6.0;
    float var_6;
    //---------
    // forward
    var_2 = (var_c < var_1);
    ...
    var_4 = df::select(var_2, var_0, var_3);
	...
	float & adj_ret)
{
    ...
    df::adj_select(var_2, var_0, var_3, adj_2, adj_0, adj_3, adj_4);
    if (var_2) {
    }
    return;
	...
	df::float3 var_p)
{
    ...
    var_1 = df::index(var_p, var_0);
    var_2 = df::abs(var_1);
    var_4 = df::index(var_p, var_3);
    var_5 = df::abs(var_4);
    var_7 = df::index(var_p, var_6);
    var_8 = df::abs(var_7);
    var_9 = df::float3(var_2, var_5, var_8);
    var_10 = df::index(var_9, var_0);
    var_11 = df::index(var_9, var_3);
    var_12 = (var_10 > var_11);
    var_13 = df::index(var_9, var_0);
    var_14 = df::index(var_9, var_6);
    var_15 = (var_13 > var_14);
    var_16 = var_12 && var_15;
    if (var_16) {
    	var_17 = df::index(var_p, var_0);
    	var_18 = df::sign(var_17);
    	var_20 = df::float3(var_18, var_19, var_19);
    	return var_20;
    }
    var_21 = df::index(var_9, var_3);
    var_22 = df::index(var_9, var_0);
    var_23 = (var_21 > var_22);
    var_24 = df::index(var_9, var_3);
    var_25 = df::index(var_9, var_6);
    var_26 = (var_24 > var_25);
    var_27 = var_23 && var_26;
    if (var_27) {
    	var_28 = df::index(var_p, var_3);
    	var_29 = df::sign(var_28);
    	var_30 = df::float3(var_19, var_29, var_19);
    	return var_30;
    }
    var_31 = df::select(var_27, var_20, var_30);
    var_32 = df::index(var_p, var_6);
    var_33 = df::sign(var_32);
    var_34 = df::float3(var_19, var_19, var_33);
    return var_34;
	...
	df::float3 & adj_ret)
{
    ...
    label2:;
    adj_34 += adj_ret;
    df::adj_float3(var_19, var_19, var_33, adj_19, adj_19, adj_33, adj_34);
    df::adj_sign(var_32, adj_32, adj_33);
    df::adj_index(var_p, var_6, adj_p, adj_6, adj_32);
    df::adj_select(var_27, var_20, var_30, adj_27, adj_20, adj_30, adj_31);
    if (var_27) {
    	label1:;
    	adj_30 += adj_ret;
    	df::adj_float3(var_19, var_29, var_19, adj_19, adj_29, adj_19, adj_30);
    	df::adj_sign(var_28, adj_28, adj_29);
    	df::adj_index(var_p, var_3, adj_p, adj_3, adj_28);
    }
    df::adj_index(var_9, var_6, adj_9, adj_6, adj_25);
    df::adj_index(var_9, var_3, adj_9, adj_3, adj_24);
    df::adj_index(var_9, var_0, adj_9, adj_0, adj_22);
    df::adj_index(var_9, var_3, adj_9, adj_3, adj_21);
    if (var_16) {
    	label0:;
    	adj_20 += adj_ret;
    	df::adj_float3(var_18, var_19, var_19, adj_18, adj_19, adj_19, adj_20);
    	df::adj_sign(var_17, adj_17, adj_18);
    	df::adj_index(var_p, var_0, adj_p, adj_0, adj_17);
    }
    df::adj_index(var_9, var_6, adj_9, adj_6, adj_14);
    df::adj_index(var_9, var_0, adj_9, adj_0, adj_13);
    df::adj_index(var_9, var_3, adj_9, adj_3, adj_11);
    df::adj_index(var_9, var_0, adj_9, adj_0, adj_10);
    df::adj_float3(var_2, var_5, var_8, adj_2, adj_5, adj_8, adj_9);
    df::adj_abs(var_7, adj_7, adj_8);
    df::adj_index(var_p, var_6, adj_p, adj_6, adj_7);
    df::adj_abs(var_4, adj_4, adj_5);
    df::adj_index(var_p, var_3, adj_p, adj_3, adj_4);
    df::adj_abs(var_1, adj_1, adj_2);
    df::adj_index(var_p, var_0, adj_p, adj_0, adj_1);
    return;
...
CUDA_CALLABLE float lerp_cuda_func(
	float var_a,
	float var_b,
	float var_t)
{
    ...
    // forward
    var_0 = df::sub(var_b, var_a);
    var_1 = df::mul(var_0, var_t);
    var_2 = df::add(var_a, var_1);
    return var_2;
    

}

CUDA_CALLABLE void adj_lerp_cuda_func(
	float var_a,
	float var_b,
	float var_t, 
	float & adj_a,
	...
	float & adj_ret)
{
    ...
    label0:;
    adj_2 += adj_ret;
    df::adj_add(var_a, var_1, adj_a, adj_1, adj_2);
    df::adj_mul(var_0, var_t, adj_0, adj_t, adj_1);
    df::adj_sub(var_b, var_a, adj_b, adj_a, adj_0);
    return;
...
CUDA_CALLABLE int sub2ind_cuda_func(
	int var_size_x,
	int var_size_y,
	int var_size_z,
	int var_x,
	...
	int var_z)
{
    ...
    //---------
    // forward
    var_0 = df::mul(var_y, var_size_x);
    var_1 = df::add(var_x, var_0);
    var_2 = df::mul(var_z, var_size_y);
    var_3 = df::mul(var_2, var_size_x);
    var_4 = df::add(var_1, var_3);
    return var_4;
    

}

CUDA_CALLABLE void adj_sub2ind_cuda_func(
	int var_size_x,
	int var_size_y,
	int var_size_z,
	int var_x,
	...
	int & adj_ret)
{
    ...
    label0:;
    adj_4 += adj_ret;
    df::adj_add(var_1, var_3, adj_1, adj_3, adj_4);
    df::adj_mul(var_2, var_size_x, adj_2, adj_size_x, adj_3);
    df::adj_mul(var_z, var_size_y, adj_z, adj_size_y, adj_2);
    df::adj_add(var_x, var_0, adj_x, adj_0, adj_1);
    df::adj_mul(var_y, var_size_x, adj_y, adj_size_x, adj_0);
    return;

}


CUDA_CALLABLE float get_sdf_cuda_func(
	df::float3 var_geo_scale,
	df::float3 var_p_local,
	float* var_geo_sdf,
	int var_tid)
{
        //---------
    ...
    const int var_4 = 2;
    float var_5;
    const float var_6 = 0.0;
    float var_7;
    const float var_8 = 0.5;
    float var_9;
    float var_10;
    float var_11;
    float var_12;
    ...
    float var_33;
    float var_34;
    const float var_35 = 256.0;
    const int var_36 = 256;
    const float var_37 = 1.0;
    float var_38;
    float var_39;
    int var_40;
    float var_41;
    ...
    float var_118;
    bool var_119;
    const float var_120 = 10.0;
    float var_121;
    float var_122;
    //---------
    // forward
    var_1 = df::index(var_p_local, var_0);
    var_3 = df::index(var_p_local, var_2);
    var_5 = df::index(var_p_local, var_4);
    var_7 = df::index(var_geo_scale, var_0);
    var_9 = df::mul(var_7, var_8);
    var_10 = df::sub(var_6, var_9);
    var_11 = df::index(var_geo_scale, var_2);
    var_12 = df::mul(var_11, var_8);
    var_13 = df::sub(var_6, var_12);
    var_14 = df::index(var_geo_scale, var_4);
    var_15 = df::mul(var_14, var_8);
    var_16 = df::sub(var_6, var_15);
    var_17 = df::index(var_geo_scale, var_0);
    var_18 = df::mul(var_17, var_8);
    var_19 = df::index(var_geo_scale, var_2);
    var_20 = df::mul(var_19, var_8);
    var_21 = df::index(var_geo_scale, var_4);
    var_22 = df::mul(var_21, var_8);
    var_23 = df::clamp(var_1, var_10, var_18);
    var_24 = df::clamp(var_3, var_13, var_20);
    var_25 = df::clamp(var_5, var_16, var_22);
    var_26 = df::index(var_geo_scale, var_0);
    var_27 = df::div(var_23, var_26);
    var_28 = df::add(var_27, var_8);
    var_29 = df::index(var_geo_scale, var_2);
    var_30 = df::div(var_24, var_29);
    var_31 = df::add(var_30, var_8);
    var_32 = df::index(var_geo_scale, var_4);
    var_33 = df::div(var_25, var_32);
    var_34 = df::add(var_33, var_8);
    var_38 = df::sub(var_35, var_37);
    var_39 = df::mul(var_28, var_38);
    var_40 = df::cast_int(var_39);
    var_41 = df::sub(var_35, var_37);
    var_42 = df::mul(var_31, var_41);
    var_43 = df::cast_int(var_42);
    var_44 = df::sub(var_35, var_37);
    var_45 = df::mul(var_34, var_44);
    var_46 = df::cast_int(var_45);
    var_47 = (var_1 <= var_10);
    var_48 = (var_1 >= var_18);
    var_49 = (var_3 <= var_13);
    var_50 = (var_3 >= var_20);
    var_51 = (var_5 <= var_16);
    var_52 = (var_5 >= var_22);
    var_53 = var_47 || var_48 || var_49 || var_50 || var_51 || var_52;
    if (var_53) {
    	var_54 = sub2ind_cuda_func(var_36, var_36, var_36, var_40, var_43, var_46);
    	var_55 = df::load(var_geo_sdf, var_54);
    	var_56 = df::sub(var_1, var_23);
    	var_57 = df::sub(var_3, var_24);
    	var_58 = df::sub(var_5, var_25);
    	var_59 = df::float3(var_56, var_57, var_58);
    	var_60 = df::length(var_59);
    	var_61 = df::add(var_55, var_60);
    	return var_61;
    }
    var_62 = df::sub(var_36, var_4);
    var_63 = df::min(var_40, var_62);
    var_64 = df::max(var_63, var_0);
    var_65 = df::sub(var_36, var_4);
    var_66 = df::min(var_43, var_65);
    var_67 = df::max(var_66, var_0);
    var_68 = df::sub(var_36, var_4);
    var_69 = df::min(var_46, var_68);
    var_70 = df::max(var_69, var_0);
    var_71 = df::sub(var_35, var_37);
    var_72 = df::mul(var_28, var_71);
    var_73 = df::mod(var_72, var_37);
    var_74 = df::sub(var_35, var_37);
    var_75 = df::mul(var_31, var_74);
    var_76 = df::mod(var_75, var_37);
    var_77 = df::sub(var_35, var_37);
    var_78 = df::mul(var_34, var_77);
    var_79 = df::mod(var_78, var_37);
    var_80 = sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_67, var_70);
    var_81 = df::load(var_geo_sdf, var_80);
    var_82 = df::add(var_64, var_2);
    var_83 = sub2ind_cuda_func(var_36, var_36, var_36, var_82, var_67, var_70);
    var_84 = df::load(var_geo_sdf, var_83);
    var_85 = df::add(var_67, var_2);
    var_86 = sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_85, var_70);
    var_87 = df::load(var_geo_sdf, var_86);
    var_88 = df::add(var_64, var_2);
    var_89 = df::add(var_67, var_2);
    var_90 = sub2ind_cuda_func(var_36, var_36, var_36, var_88, var_89, var_70);
    var_91 = df::load(var_geo_sdf, var_90);
    var_92 = df::add(var_70, var_2);
    var_93 = sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_67, var_92);
    var_94 = df::load(var_geo_sdf, var_93);
    var_95 = df::add(var_64, var_2);
    var_96 = df::add(var_70, var_2);
    var_97 = sub2ind_cuda_func(var_36, var_36, var_36, var_95, var_67, var_96);
    var_98 = df::load(var_geo_sdf, var_97);
    var_99 = df::add(var_67, var_2);
    var_100 = df::add(var_70, var_2);
    var_101 = sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_99, var_100);
    var_102 = df::load(var_geo_sdf, var_101);
    var_103 = df::add(var_64, var_2);
    var_104 = df::add(var_67, var_2);
    var_105 = df::add(var_70, var_2);
    var_106 = sub2ind_cuda_func(var_36, var_36, var_36, var_103, var_104, var_105);
    var_107 = df::load(var_geo_sdf, var_106);
    var_108 = lerp_cuda_func(var_81, var_84, var_73);
    var_109 = lerp_cuda_func(var_87, var_91, var_73);
    var_110 = lerp_cuda_func(var_94, var_98, var_73);
    var_111 = lerp_cuda_func(var_102, var_107, var_73);
    var_112 = lerp_cuda_func(var_108, var_109, var_76);
    var_113 = lerp_cuda_func(var_110, var_111, var_76);
    var_114 = df::sub(var_1, var_23);
    var_115 = df::sub(var_3, var_24);
    var_116 = df::sub(var_5, var_25);
    var_117 = df::float3(var_114, var_115, var_116);
    var_118 = df::length(var_117);
    var_119 = (var_118 > var_6);
    if (var_119) {
    	return var_120;
    }
    var_121 = df::select(var_119, var_61, var_120);
    var_122 = lerp_cuda_func(var_112, var_113, var_79);
    return var_122;
    

}

CUDA_CALLABLE void adj_get_sdf_cuda_func(
	df::float3 var_geo_scale,
	df::float3 var_p_local,
	float* var_geo_sdf,
	int var_tid, 
	df::float3 & adj_geo_scale,
	df::float3 & adj_p_local,
	float* adj_geo_sdf,
	int & adj_tid,
	float & adj_ret)
{
    ...
    label2:;
    adj_122 += adj_ret;
    adj_lerp_cuda_func(var_112, var_113, var_79, adj_112, adj_113, adj_79, adj_122);
    df::adj_select(var_119, var_61, var_120, adj_119, adj_61, adj_120, adj_121);
    if (var_119) {
    	label1:;
    	adj_120 += adj_ret;
    }
    df::adj_length(var_117, adj_117, adj_118);
    df::adj_float3(var_114, var_115, var_116, adj_114, adj_115, adj_116, adj_117);
    df::adj_sub(var_5, var_25, adj_5, adj_25, adj_116);
    df::adj_sub(var_3, var_24, adj_3, adj_24, adj_115);
    df::adj_sub(var_1, var_23, adj_1, adj_23, adj_114);
    adj_lerp_cuda_func(var_110, var_111, var_76, adj_110, adj_111, adj_76, adj_113);
    adj_lerp_cuda_func(var_108, var_109, var_76, adj_108, adj_109, adj_76, adj_112);
    adj_lerp_cuda_func(var_102, var_107, var_73, adj_102, adj_107, adj_73, adj_111);
    adj_lerp_cuda_func(var_94, var_98, var_73, adj_94, adj_98, adj_73, adj_110);
    adj_lerp_cuda_func(var_87, var_91, var_73, adj_87, adj_91, adj_73, adj_109);
    adj_lerp_cuda_func(var_81, var_84, var_73, adj_81, adj_84, adj_73, adj_108);
    df::adj_load(var_geo_sdf, var_106, adj_geo_sdf, adj_106, adj_107);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_103, var_104, var_105, adj_36, adj_36, adj_36, adj_103, adj_104, adj_105, adj_106);
    df::adj_add(var_70, var_2, adj_70, adj_2, adj_105);
    df::adj_add(var_67, var_2, adj_67, adj_2, adj_104);
    df::adj_add(var_64, var_2, adj_64, adj_2, adj_103);
    df::adj_load(var_geo_sdf, var_101, adj_geo_sdf, adj_101, adj_102);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_99, var_100, adj_36, adj_36, adj_36, adj_64, adj_99, adj_100, adj_101);
    df::adj_add(var_70, var_2, adj_70, adj_2, adj_100);
    df::adj_add(var_67, var_2, adj_67, adj_2, adj_99);
    df::adj_load(var_geo_sdf, var_97, adj_geo_sdf, adj_97, adj_98);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_95, var_67, var_96, adj_36, adj_36, adj_36, adj_95, adj_67, adj_96, adj_97);
    df::adj_add(var_70, var_2, adj_70, adj_2, adj_96);
    df::adj_add(var_64, var_2, adj_64, adj_2, adj_95);
    df::adj_load(var_geo_sdf, var_93, adj_geo_sdf, adj_93, adj_94);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_67, var_92, adj_36, adj_36, adj_36, adj_64, adj_67, adj_92, adj_93);
    df::adj_add(var_70, var_2, adj_70, adj_2, adj_92);
    df::adj_load(var_geo_sdf, var_90, adj_geo_sdf, adj_90, adj_91);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_88, var_89, var_70, adj_36, adj_36, adj_36, adj_88, adj_89, adj_70, adj_90);
    df::adj_add(var_67, var_2, adj_67, adj_2, adj_89);
    df::adj_add(var_64, var_2, adj_64, adj_2, adj_88);
    df::adj_load(var_geo_sdf, var_86, adj_geo_sdf, adj_86, adj_87);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_85, var_70, adj_36, adj_36, adj_36, adj_64, adj_85, adj_70, adj_86);
    df::adj_add(var_67, var_2, adj_67, adj_2, adj_85);
    df::adj_load(var_geo_sdf, var_83, adj_geo_sdf, adj_83, adj_84);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_82, var_67, var_70, adj_36, adj_36, adj_36, adj_82, adj_67, adj_70, adj_83);
    df::adj_add(var_64, var_2, adj_64, adj_2, adj_82);
    df::adj_load(var_geo_sdf, var_80, adj_geo_sdf, adj_80, adj_81);
    adj_sub2ind_cuda_func(var_36, var_36, var_36, var_64, var_67, var_70, adj_36, adj_36, adj_36, adj_64, adj_67, adj_70, adj_80);
    df::adj_mod(var_78, var_37, adj_78, adj_37, adj_79);
    df::adj_mul(var_34, var_77, adj_34, adj_77, adj_78);
    df::adj_sub(var_35, var_37, adj_35, adj_37, adj_77);
    df::adj_mod(var_75, var_37, adj_75, adj_37, adj_76);
    df::adj_mul(var_31, var_74, adj_31, adj_74, adj_75);
    df::adj_sub(var_35, var_37, adj_35, adj_37, adj_74);
    df::adj_mod(var_72, var_37, adj_72, adj_37, adj_73);
    df::adj_mul(var_28, var_71, adj_28, adj_71, adj_72);
    df::adj_sub(var_35, var_37, adj_35, adj_37, adj_71);
    df::adj_max(var_69, var_0, adj_69, adj_0, adj_70);
    df::adj_min(var_46, var_68, adj_46, adj_68, adj_69);
    df::adj_sub(var_36, var_4, adj_36, adj_4, adj_68);
    df::adj_max(var_66, var_0, adj_66, adj_0, adj_67);
    df::adj_min(var_43, var_65, adj_43, adj_65, adj_66);
    df::adj_sub(var_36, var_4, adj_36, adj_4, adj_65);
    df::adj_max(var_63, var_0, adj_63, adj_0, adj_64);
    df::adj_min(var_40, var_62, adj_40, adj_62, adj_63);
    df::adj_sub(var_36, var_4, adj_36, adj_4, adj_62);
    if (var_53) {
    	label0:;
    	adj_61 += adj_ret;
    	df::adj_add(var_55, var_60, adj_55, adj_60, adj_61);
    	df::adj_length(var_59, adj_59, adj_60);
    	df::adj_float3(var_56, var_57, var_58, adj_56, adj_57, adj_58, adj_59);
    	df::adj_sub(var_5, var_25, adj_5, adj_25, adj_58);
    	df::adj_sub(var_3, var_24, adj_3, adj_24, adj_57);
    	df::adj_sub(var_1, var_23, adj_1, adj_23, adj_56);
    	df::adj_load(var_geo_sdf, var_54, adj_geo_sdf, adj_54, adj_55);
    	adj_sub2ind_cuda_func(var_36, var_36, var_36, var_40, var_43, var_46, adj_36, adj_36, adj_36, adj_40, adj_43, adj_46, adj_54);
    }
    df::adj_cast_int(var_45, adj_45, adj_46);
    df::adj_mul(var_34, var_44, adj_34, adj_44, adj_45);
    df::adj_sub(var_35, var_37, adj_35, adj_37, adj_44);
    df::adj_cast_int(var_42, adj_42, adj_43);
    df::adj_mul(var_31, var_41, adj_31, adj_41, adj_42);
    df::adj_sub(var_35, var_37, adj_35, adj_37, adj_41);
    df::adj_cast_int(var_39, adj_39, adj_40);
    df::adj_mul(var_28, var_38, adj_28, adj_38, adj_39);
    df::adj_sub(var_35, var_37, adj_35, adj_37, adj_38);
    df::adj_add(var_33, var_8, adj_33, adj_8, adj_34);
    df::adj_div(var_25, var_32, adj_25, adj_32, adj_33);
    df::adj_index(var_geo_scale, var_4, adj_geo_scale, adj_4, adj_32);
    df::adj_add(var_30, var_8, adj_30, adj_8, adj_31);
    df::adj_div(var_24, var_29, adj_24, adj_29, adj_30);
    df::adj_index(var_geo_scale, var_2, adj_geo_scale, adj_2, adj_29);
    df::adj_add(var_27, var_8, adj_27, adj_8, adj_28);
    df::adj_div(var_23, var_26, adj_23, adj_26, adj_27);
    df::adj_index(var_geo_scale, var_0, adj_geo_scale, adj_0, adj_26);
    df::adj_clamp(var_5, var_16, var_22, adj_5, adj_16, adj_22, adj_25);
    df::adj_clamp(var_3, var_13, var_20, adj_3, adj_13, adj_20, adj_24);
    df::adj_clamp(var_1, var_10, var_18, adj_1, adj_10, adj_18, adj_23);
    df::adj_mul(var_21, var_8, adj_21, adj_8, adj_22);
    df::adj_index(var_geo_scale, var_4, adj_geo_scale, adj_4, adj_21);
    df::adj_mul(var_19, var_8, adj_19, adj_8, adj_20);
    df::adj_index(var_geo_scale, var_2, adj_geo_scale, adj_2, adj_19);
    df::adj_mul(var_17, var_8, adj_17, adj_8, adj_18);
    df::adj_index(var_geo_scale, var_0, adj_geo_scale, adj_0, adj_17);
    df::adj_sub(var_6, var_15, adj_6, adj_15, adj_16);
    df::adj_mul(var_14, var_8, adj_14, adj_8, adj_15);
    df::adj_index(var_geo_scale, var_4, adj_geo_scale, adj_4, adj_14);
    df::adj_sub(var_6, var_12, adj_6, adj_12, adj_13);
    df::adj_mul(var_11, var_8, adj_11, adj_8, adj_12);
    df::adj_index(var_geo_scale, var_2, adj_geo_scale, adj_2, adj_11);
    df::adj_sub(var_6, var_9, adj_6, adj_9, adj_10);
    df::adj_mul(var_7, var_8, adj_7, adj_8, adj_9);
    df::adj_index(var_geo_scale, var_0, adj_geo_scale, adj_0, adj_7);
    df::adj_index(var_p_local, var_4, adj_p_local, adj_4, adj_5);
    df::adj_index(var_p_local, var_2, adj_p_local, adj_2, adj_3);
    df::adj_index(var_p_local, var_0, adj_p_local, adj_0, adj_1);
    return;
	...
	float* var_tau)
{
    ...
    float var_86;
    float var_87;
    spatial_vector var_88;
    const int var_89 = 4;
    bool var_90;
    const int var_91 = 0;
    int var_92;
    spatial_vector var_93;
    int var_94;
    float var_95;
    float var_96;
    const int var_97 = 1;
    int var_98;
    spatial_vector var_99;
    int var_100;
    float var_101;
    float var_102;
    const int var_103 = 2;
    int var_104;
    spatial_vector var_105;
    int var_106;
    float var_107;
    float var_108;
    const int var_109 = 3;
    int var_110;
    spatial_vector var_111;
    int var_112;
    float var_113;
    float var_114;
    const int var_115 = 4;
    int var_116;
    spatial_vector var_117;
    int var_118;
    float var_119;
    float var_120;
    const int var_121 = 5;
    int var_122;
    spatial_vector var_123;
    int var_124;
    float var_125;
    float var_126;
    spatial_vector var_127;
    int var_128;
    //---------
    // forward
    var_1 = (var_type == var_0);
    ...
    if (var_4) {
    	...
    	if (var_13) {
    		...
    		var_16 = df::min(var_7, var_12);
    		var_17 = df::mul(var_limit_k_d, var_16);
    		var_18 = df::sub(var_15, var_17);
    	}
    	var_19 = df::select(var_13, var_12, var_18);
    	var_20 = (var_6 > var_11);
    	if (var_20) {
    		var_21 = df::sub(var_11, var_6);
    		var_22 = df::mul(var_limit_k_e, var_21);
    		var_23 = df::max(var_7, var_12);
    		var_24 = df::mul(var_limit_k_d, var_23);
    		var_25 = df::sub(var_22, var_24);
    	}
    	var_26 = df::select(var_20, var_19, var_25);
    	var_27 = df::spatial_dot(var_5, var_body_f_s);
    	var_28 = df::sub(var_12, var_27);
    	var_29 = df::sub(var_6, var_9);
    	var_30 = df::mul(var_target_k_e, var_29);
    	var_31 = df::sub(var_28, var_30);
    	var_32 = df::mul(var_target_k_d, var_7);
    	var_33 = df::sub(var_31, var_32);
    	var_34 = df::add(var_33, var_8);
    	var_35 = df::add(var_34, var_26);
    	df::store(var_tau, var_dof_start, var_35);
    }
    var_37 = (var_type == var_36);
    if (var_37) {
    	var_38 = df::add(var_coord_start, var_0);
    	var_39 = df::load(var_joint_q, var_38);
    	var_40 = df::add(var_coord_start, var_2);
    	var_41 = df::load(var_joint_q, var_40);
    	var_42 = df::add(var_coord_start, var_36);
    	var_43 = df::load(var_joint_q, var_42);
    	var_44 = df::float3(var_39, var_41, var_43);
    	var_45 = df::add(var_dof_start, var_0);
    	var_46 = df::load(var_joint_qd, var_45);
    	var_47 = df::add(var_dof_start, var_2);
    	var_48 = df::load(var_joint_qd, var_47);
    	var_49 = df::add(var_dof_start, var_36);
    	var_50 = df::load(var_joint_qd, var_49);
    	var_51 = df::float3(var_46, var_48, var_50);
    	var_53 = df::add(var_dof_start, var_52);
    	var_54 = df::load(var_joint_S_s, var_53);
    	var_55 = df::index(var_51, var_52);
    	var_56 = df::index(var_44, var_52);
    	var_57 = df::add(var_dof_start, var_52);
    	var_58 = df::spatial_dot(var_54, var_body_f_s);
    	var_59 = df::sub(var_12, var_58);
    	var_60 = df::mul(var_55, var_target_k_d);
    	var_61 = df::sub(var_59, var_60);
    	var_62 = df::mul(var_56, var_target_k_e);
    	var_63 = df::sub(var_61, var_62);
    	df::store(var_tau, var_57, var_63);
    	var_65 = df::add(var_dof_start, var_64);
    	var_66 = df::load(var_joint_S_s, var_65);
    	var_67 = df::index(var_51, var_64);
    	var_68 = df::index(var_44, var_64);
    	var_69 = df::add(var_dof_start, var_64);
    	var_70 = df::spatial_dot(var_66, var_body_f_s);
    	var_71 = df::sub(var_12, var_70);
    	var_72 = df::mul(var_67, var_target_k_d);
    	var_73 = df::sub(var_71, var_72);
    	var_74 = df::mul(var_68, var_target_k_e);
    	var_75 = df::sub(var_73, var_74);
    	df::store(var_tau, var_69, var_75);
    	var_77 = df::add(var_dof_start, var_76);
    	var_78 = df::load(var_joint_S_s, var_77);
    	var_79 = df::index(var_51, var_76);
    	var_80 = df::index(var_44, var_76);
    	var_81 = df::add(var_dof_start, var_76);
    	var_82 = df::spatial_dot(var_78, var_body_f_s);
    	var_83 = df::sub(var_12, var_82);
    	var_84 = df::mul(var_79, var_target_k_d);
    	var_85 = df::sub(var_83, var_84);
    	var_86 = df::mul(var_80, var_target_k_e);
    	var_87 = df::sub(var_85, var_86);
    	df::store(var_tau, var_81, var_87);
    }
    var_88 = df::select(var_37, var_5, var_78);
    var_90 = (var_type == var_89);
    if (var_90) {
    	var_92 = df::add(var_dof_start, var_91);
    	var_93 = df::load(var_joint_S_s, var_92);
    	var_94 = df::add(var_dof_start, var_91);
    	var_95 = df::spatial_dot(var_93, var_body_f_s);
    	var_96 = df::sub(var_12, var_95);
    	df::store(var_tau, var_94, var_96);
    	var_98 = df::add(var_dof_start, var_97);
    	var_99 = df::load(var_joint_S_s, var_98);
    	var_100 = df::add(var_dof_start, var_97);
    	var_101 = df::spatial_dot(var_99, var_body_f_s);
    	var_102 = df::sub(var_12, var_101);
    	df::store(var_tau, var_100, var_102);
    	var_104 = df::add(var_dof_start, var_103);
    	var_105 = df::load(var_joint_S_s, var_104);
    	var_106 = df::add(var_dof_start, var_103);
    	var_107 = df::spatial_dot(var_105, var_body_f_s);
    	var_108 = df::sub(var_12, var_107);
    	df::store(var_tau, var_106, var_108);
    	var_110 = df::add(var_dof_start, var_109);
    	var_111 = df::load(var_joint_S_s, var_110);
    	var_112 = df::add(var_dof_start, var_109);
    	var_113 = df::spatial_dot(var_111, var_body_f_s);
    	var_114 = df::sub(var_12, var_113);
    	df::store(var_tau, var_112, var_114);
    	var_116 = df::add(var_dof_start, var_115);
    	var_117 = df::load(var_joint_S_s, var_116);
    	var_118 = df::add(var_dof_start, var_115);
    	var_119 = df::spatial_dot(var_117, var_body_f_s);
    	var_120 = df::sub(var_12, var_119);
    	df::store(var_tau, var_118, var_120);
    	var_122 = df::add(var_dof_start, var_121);
    	var_123 = df::load(var_joint_S_s, var_122);
    	var_124 = df::add(var_dof_start, var_121);
    	var_125 = df::spatial_dot(var_123, var_body_f_s);
    	var_126 = df::sub(var_12, var_125);
    	df::store(var_tau, var_124, var_126);
    }
    var_127 = df::select(var_90, var_88, var_123);
    var_128 = df::select(var_90, var_76, var_121);
    return var_0;
	...
	int & adj_ret)
{
    ...
    float adj_86 = 0;
    float adj_87 = 0;
    spatial_vector adj_88 = 0;
    int adj_89 = 0;
    bool adj_90 = 0;
    int adj_91 = 0;
    int adj_92 = 0;
    spatial_vector adj_93 = 0;
    int adj_94 = 0;
    float adj_95 = 0;
    float adj_96 = 0;
    int adj_97 = 0;
    int adj_98 = 0;
    spatial_vector adj_99 = 0;
    int adj_100 = 0;
    float adj_101 = 0;
    float adj_102 = 0;
    int adj_103 = 0;
    int adj_104 = 0;
    spatial_vector adj_105 = 0;
    int adj_106 = 0;
    float adj_107 = 0;
    float adj_108 = 0;
    int adj_109 = 0;
    int adj_110 = 0;
    spatial_vector adj_111 = 0;
    int adj_112 = 0;
    float adj_113 = 0;
    float adj_114 = 0;
    int adj_115 = 0;
    int adj_116 = 0;
    spatial_vector adj_117 = 0;
    int adj_118 = 0;
    float adj_119 = 0;
    float adj_120 = 0;
    int adj_121 = 0;
    int adj_122 = 0;
    spatial_vector adj_123 = 0;
    int adj_124 = 0;
    float adj_125 = 0;
    float adj_126 = 0;
    spatial_vector adj_127 = 0;
    int adj_128 = 0;
    //---------
    // forward
    var_1 = (var_type == var_0);
    ...
    label0:;
    adj_0 += adj_ret;
    df::adj_select(var_90, var_76, var_121, adj_90, adj_76, adj_121, adj_128);
    df::adj_select(var_90, var_88, var_123, adj_90, adj_88, adj_123, adj_127);
    if (var_90) {
    	df::adj_store(var_tau, var_124, var_126, adj_tau, adj_124, adj_126);
    	df::adj_sub(var_12, var_125, adj_12, adj_125, adj_126);
    	df::adj_spatial_dot(var_123, var_body_f_s, adj_123, adj_body_f_s, adj_125);
    	df::adj_add(var_dof_start, var_121, adj_dof_start, adj_121, adj_124);
    	df::adj_load(var_joint_S_s, var_122, adj_joint_S_s, adj_122, adj_123);
    	df::adj_add(var_dof_start, var_121, adj_dof_start, adj_121, adj_122);
    	df::adj_store(var_tau, var_118, var_120, adj_tau, adj_118, adj_120);
    	df::adj_sub(var_12, var_119, adj_12, adj_119, adj_120);
    	df::adj_spatial_dot(var_117, var_body_f_s, adj_117, adj_body_f_s, adj_119);
    	df::adj_add(var_dof_start, var_115, adj_dof_start, adj_115, adj_118);
    	df::adj_load(var_joint_S_s, var_116, adj_joint_S_s, adj_116, adj_117);
    	df::adj_add(var_dof_start, var_115, adj_dof_start, adj_115, adj_116);
    	df::adj_store(var_tau, var_112, var_114, adj_tau, adj_112, adj_114);
    	df::adj_sub(var_12, var_113, adj_12, adj_113, adj_114);
    	df::adj_spatial_dot(var_111, var_body_f_s, adj_111, adj_body_f_s, adj_113);
    	df::adj_add(var_dof_start, var_109, adj_dof_start, adj_109, adj_112);
    	df::adj_load(var_joint_S_s, var_110, adj_joint_S_s, adj_110, adj_111);
    	df::adj_add(var_dof_start, var_109, adj_dof_start, adj_109, adj_110);
    	df::adj_store(var_tau, var_106, var_108, adj_tau, adj_106, adj_108);
    	df::adj_sub(var_12, var_107, adj_12, adj_107, adj_108);
    	df::adj_spatial_dot(var_105, var_body_f_s, adj_105, adj_body_f_s, adj_107);
    	df::adj_add(var_dof_start, var_103, adj_dof_start, adj_103, adj_106);
    	df::adj_load(var_joint_S_s, var_104, adj_joint_S_s, adj_104, adj_105);
    	df::adj_add(var_dof_start, var_103, adj_dof_start, adj_103, adj_104);
    	df::adj_store(var_tau, var_100, var_102, adj_tau, adj_100, adj_102);
    	df::adj_sub(var_12, var_101, adj_12, adj_101, adj_102);
    	df::adj_spatial_dot(var_99, var_body_f_s, adj_99, adj_body_f_s, adj_101);
    	df::adj_add(var_dof_start, var_97, adj_dof_start, adj_97, adj_100);
    	df::adj_load(var_joint_S_s, var_98, adj_joint_S_s, adj_98, adj_99);
    	df::adj_add(var_dof_start, var_97, adj_dof_start, adj_97, adj_98);
    	df::adj_store(var_tau, var_94, var_96, adj_tau, adj_94, adj_96);
    	df::adj_sub(var_12, var_95, adj_12, adj_95, adj_96);
    	df::adj_spatial_dot(var_93, var_body_f_s, adj_93, adj_body_f_s, adj_95);
    	df::adj_add(var_dof_start, var_91, adj_dof_start, adj_91, adj_94);
    	df::adj_load(var_joint_S_s, var_92, adj_joint_S_s, adj_92, adj_93);
    	df::adj_add(var_dof_start, var_91, adj_dof_start, adj_91, adj_92);
    }
    df::adj_select(var_37, var_5, var_78, adj_37, adj_5, adj_78, adj_88);
    if (var_37) {
    	df::adj_store(var_tau, var_81, var_87, adj_tau, adj_81, adj_87);
    	df::adj_sub(var_85, var_86, adj_85, adj_86, adj_87);
    	df::adj_mul(var_80, var_target_k_e, adj_80, adj_target_k_e, adj_86);
    	df::adj_sub(var_83, var_84, adj_83, adj_84, adj_85);
    	df::adj_mul(var_79, var_target_k_d, adj_79, adj_target_k_d, adj_84);
    	df::adj_sub(var_12, var_82, adj_12, adj_82, adj_83);
    	df::adj_spatial_dot(var_78, var_body_f_s, adj_78, adj_body_f_s, adj_82);
    	df::adj_add(var_dof_start, var_76, adj_dof_start, adj_76, adj_81);
    	df::adj_index(var_44, var_76, adj_44, adj_76, adj_80);
    	df::adj_index(var_51, var_76, adj_51, adj_76, adj_79);
    	df::adj_load(var_joint_S_s, var_77, adj_joint_S_s, adj_77, adj_78);
    	df::adj_add(var_dof_start, var_76, adj_dof_start, adj_76, adj_77);
    	df::adj_store(var_tau, var_69, var_75, adj_tau, adj_69, adj_75);
    	df::adj_sub(var_73, var_74, adj_73, adj_74, adj_75);
    	df::adj_mul(var_68, var_target_k_e, adj_68, adj_target_k_e, adj_74);
    	df::adj_sub(var_71, var_72, adj_71, adj_72, adj_73);
    	df::adj_mul(var_67, var_target_k_d, adj_67, adj_target_k_d, adj_72);
    	df::adj_sub(var_12, var_70, adj_12, adj_70, adj_71);
    	df::adj_spatial_dot(var_66, var_body_f_s, adj_66, adj_body_f_s, adj_70);
    	df::adj_add(var_dof_start, var_64, adj_dof_start, adj_64, adj_69);
    	df::adj_index(var_44, var_64, adj_44, adj_64, adj_68);
    	df::adj_index(var_51, var_64, adj_51, adj_64, adj_67);
    	df::adj_load(var_joint_S_s, var_65, adj_joint_S_s, adj_65, adj_66);
    	df::adj_add(var_dof_start, var_64, adj_dof_start, adj_64, adj_65);
    	df::adj_store(var_tau, var_57, var_63, adj_tau, adj_57, adj_63);
    	df::adj_sub(var_61, var_62, adj_61, adj_62, adj_63);
    	df::adj_mul(var_56, var_target_k_e, adj_56, adj_target_k_e, adj_62);
    	df::adj_sub(var_59, var_60, adj_59, adj_60, adj_61);
    	df::adj_mul(var_55, var_target_k_d, adj_55, adj_target_k_d, adj_60);
    	df::adj_sub(var_12, var_58, adj_12, adj_58, adj_59);
    	df::adj_spatial_dot(var_54, var_body_f_s, adj_54, adj_body_f_s, adj_58);
    	df::adj_add(var_dof_start, var_52, adj_dof_start, adj_52, adj_57);
    	df::adj_index(var_44, var_52, adj_44, adj_52, adj_56);
    	df::adj_index(var_51, var_52, adj_51, adj_52, adj_55);
    	df::adj_load(var_joint_S_s, var_53, adj_joint_S_s, adj_53, adj_54);
    	df::adj_add(var_dof_start, var_52, adj_dof_start, adj_52, adj_53);
    	df::adj_float3(var_46, var_48, var_50, adj_46, adj_48, adj_50, adj_51);
    	df::adj_load(var_joint_qd, var_49, adj_joint_qd, adj_49, adj_50);
    	df::adj_add(var_dof_start, var_36, adj_dof_start, adj_36, adj_49);
    	df::adj_load(var_joint_qd, var_47, adj_joint_qd, adj_47, adj_48);
    	df::adj_add(var_dof_start, var_2, adj_dof_start, adj_2, adj_47);
    	df::adj_load(var_joint_qd, var_45, adj_joint_qd, adj_45, adj_46);
    	df::adj_add(var_dof_start, var_0, adj_dof_start, adj_0, adj_45);
    	df::adj_float3(var_39, var_41, var_43, adj_39, adj_41, adj_43, adj_44);
    	df::adj_load(var_joint_q, var_42, adj_joint_q, adj_42, adj_43);
    	df::adj_add(var_coord_start, var_36, adj_coord_start, adj_36, adj_42);
    	df::adj_load(var_joint_q, var_40, adj_joint_q, adj_40, adj_41);
    	df::adj_add(var_coord_start, var_2, adj_coord_start, adj_2, adj_40);
    	df::adj_load(var_joint_q, var_38, adj_joint_q, adj_38, adj_39);
    	df::adj_add(var_coord_start, var_0, adj_coord_start, adj_0, adj_38);
    }
    if (var_4) {
    	df::adj_store(var_tau, var_dof_start, var_35, adj_tau, adj_dof_start, adj_35);
    	df::adj_add(var_34, var_26, adj_34, adj_26, adj_35);
    	df::adj_add(var_33, var_8, adj_33, adj_8, adj_34);
    	df::adj_sub(var_31, var_32, adj_31, adj_32, adj_33);
    	df::adj_mul(var_target_k_d, var_7, adj_target_k_d, adj_7, adj_32);
    	df::adj_sub(var_28, var_30, adj_28, adj_30, adj_31);
    	df::adj_mul(var_target_k_e, var_29, adj_target_k_e, adj_29, adj_30);
    	df::adj_sub(var_6, var_9, adj_6, adj_9, adj_29);
    	df::adj_sub(var_12, var_27, adj_12, adj_27, adj_28);
    	df::adj_spatial_dot(var_5, var_body_f_s, adj_5, adj_body_f_s, adj_27);
    	df::adj_select(var_20, var_19, var_25, adj_20, adj_19, adj_25, adj_26);
    	if (var_20) {
    		df::adj_sub(var_22, var_24, adj_22, adj_24, adj_25);
    		df::adj_mul(var_limit_k_d, var_23, adj_limit_k_d, adj_23, adj_24);
    		df::adj_max(var_7, var_12, adj_7, adj_12, adj_23);
    		df::adj_mul(var_limit_k_e, var_21, adj_limit_k_e, adj_21, adj_22);
    		df::adj_sub(var_11, var_6, adj_11, adj_6, adj_21);
    	}
    	df::adj_select(var_13, var_12, var_18, adj_13, adj_12, adj_18, adj_19);
    	if (var_13) {
    		df::adj_sub(var_15, var_17, adj_15, adj_17, adj_18);
    		df::adj_mul(var_limit_k_d, var_16, adj_limit_k_d, adj_16, adj_17);
    		df::adj_min(var_7, var_12, adj_7, adj_12, adj_16);
...
__global__ void eval_rigid_contacts_art_cuda_kernel_forward(int dim, 
	...
	df::float3* var_shape_geo_scale,
	float* var_geo_sdf,
	int* var_contact_body0,
	int* var_contact_body1,
	int* var_contact_shape0,
	int* var_contact_shape1,
	df::float3* var_contact_point,
	float* var_contact_dist,
	int* var_contact_mat,
	float* var_materials,
	...
	wrench_matrix* var_contact_matrix)
{
    ...
    int var_25;
    float var_26;
    spatial_transform var_27;
    spatial_vector var_28;
    const float var_29 = 0.0;
    const float var_30 = 1.0;
    df::float3 var_31;
    df::float3 var_32;
    df::float3 var_33;
    df::float3 var_34;
    ...
    df::float3 var_62;
    df::float3 var_63;
    spatial_vector var_64;
    float var_65;
    float var_66;
    float var_67;
    float var_68;
    spatial_transform var_69;
    spatial_vector var_70;
    df::float3 var_71;
    df::float3 var_72;
    df::float3 var_73;
    df::float3 var_74;
    ...
    df::float3 var_76;
    df::float3 var_77;
    spatial_transform var_78;
    spatial_transform var_79;
    spatial_transform var_80;
    spatial_transform var_81;
    df::float3 var_82;
    int var_83;
    df::float3 var_84;
    df::float3 var_85;
    ...
    if (var_idx < dim) {
        var_0 = df::tid();
        var_1 = df::load(var_contact_body0, var_0);
        var_2 = df::load(var_contact_body1, var_0);
        var_3 = df::load(var_contact_shape0, var_0);
        var_4 = df::load(var_contact_shape1, var_0);
        var_5 = df::load(var_contact_point, var_0);
        var_6 = df::load(var_contact_dist, var_0);
        var_7 = df::load(var_contact_mat, var_0);
        var_10 = df::sub(var_8, var_9);
        var_11 = (var_2 == var_10);
        if (var_11) {
        	var_13 = df::mul(var_7, var_12);
        	var_14 = df::add(var_13, var_8);
        	var_15 = df::load(var_materials, var_14);
        	var_16 = df::mul(var_7, var_12);
        	var_17 = df::add(var_16, var_9);
        	var_18 = df::load(var_materials, var_17);
        	var_19 = df::mul(var_7, var_12);
        	var_21 = df::add(var_19, var_20);
        	var_22 = df::load(var_materials, var_21);
        	var_23 = df::mul(var_7, var_12);
        	var_25 = df::add(var_23, var_24);
        	var_26 = df::load(var_materials, var_25);
        	var_27 = df::load(var_body_X_s, var_1);
        	var_28 = df::load(var_body_v_s, var_1);
        	var_31 = df::float3(var_29, var_30, var_29);
        	var_32 = df::spatial_transform_point(var_27, var_5);
        	var_33 = df::spatial_top(var_28);
        	var_34 = df::spatial_bottom(var_28);
        	var_35 = df::cross(var_33, var_32);
        	var_36 = df::add(var_34, var_35);
        	var_37 = df::dot(var_31, var_32);
        	var_38 = df::sub(var_37, var_6);
        	var_39 = df::min(var_38, var_29);
        	var_40 = df::dot(var_31, var_36);
        	var_41 = df::mul(var_31, var_40);
        	var_42 = df::sub(var_36, var_41);
        	var_43 = df::mul(var_39, var_15);
        	var_44 = df::min(var_40, var_29);
        	var_45 = df::mul(var_44, var_18);
        	var_46 = df::step(var_39);
        	var_47 = df::mul(var_45, var_46);
        	var_48 = df::add(var_43, var_47);
        	var_49 = df::mul(var_26, var_48);
        	var_50 = df::sub(var_29, var_49);
        	var_51 = df::float3(var_22, var_29, var_29);
        	var_52 = df::dot(var_51, var_42);
        	var_53 = df::clamp(var_52, var_49, var_50);
        	var_54 = df::float3(var_29, var_29, var_22);
        	var_55 = df::dot(var_54, var_42);
        	var_56 = df::clamp(var_55, var_49, var_50);
        	var_57 = df::float3(var_53, var_29, var_56);
        	var_58 = df::step(var_39);
        	var_59 = df::mul(var_57, var_58);
        	var_60 = df::add(var_43, var_47);
        	var_61 = df::mul(var_31, var_60);
        	var_62 = df::add(var_61, var_59);
        	var_63 = df::cross(var_5, var_62);
        	var_64 = df::spatial_vector(var_63, var_62);
        	df::atomic_add(var_body_f_s, var_1, var_64);
        	return;
        }
        var_65 = df::select(var_11, var_ke, var_15);
        var_66 = df::select(var_11, var_kd, var_18);
        var_67 = df::select(var_11, var_kf, var_22);
        var_68 = df::select(var_11, var_mu, var_26);
        var_69 = df::load(var_body_X_s, var_1);
        var_70 = df::load(var_body_v_s, var_1);
        var_71 = df::spatial_transform_point(var_69, var_5);
        var_72 = df::spatial_top(var_70);
        var_73 = df::spatial_bottom(var_70);
        var_74 = df::spatial_transform_get_translation(var_69);
        var_75 = df::sub(var_71, var_74);
        var_76 = df::cross(var_72, var_75);
        var_77 = df::add(var_73, var_76);
        var_78 = df::load(var_body_X_s, var_2);
        var_79 = df::load(var_shape_X_co, var_4);
        var_80 = df::spatial_transform_multiply(var_78, var_79);
        var_81 = spatial_transform_inverse_cuda_func(var_80);
        var_82 = df::spatial_transform_point(var_81, var_71);
        var_83 = df::load(var_shape_geo_type, var_3);
        var_84 = df::load(var_shape_geo_scale, var_3);
        var_85 = df::float3(var_29, var_29, var_29);
        var_86 = (var_83 == var_9);
        if (var_86) {
        	var_87 = box_sdf_grad_cuda_func(var_84, var_5);
        	var_88 = spatial_transform_inverse_cuda_func(var_69);
        	var_89 = df::spatial_transform_vector(var_88, var_87);
        }
        var_90 = df::select(var_86, var_85, var_89);
        var_91 = df::load(var_shape_geo_type, var_4);
        var_92 = df::load(var_shape_geo_scale, var_4);
        var_93 = df::float3(var_29, var_29, var_29);
        var_94 = (var_91 == var_8);
        if (var_94) {
        	var_95 = df::float3(var_29, var_29, var_29);
        	var_96 = df::index(var_92, var_8);
        	var_97 = sphere_sdf_cuda_func(var_95, var_96, var_82);
        	var_98 = df::sub(var_97, var_6);
        	var_99 = df::min(var_98, var_29);
        	var_100 = df::float3(var_29, var_29, var_29);
        	var_101 = df::index(var_92, var_8);
        	var_102 = sphere_sdf_grad_cuda_func(var_100, var_101, var_82);
        	var_103 = df::spatial_transform_vector(var_80, var_102);
        }
        var_104 = df::select(var_94, var_93, var_103);
        var_105 = df::select(var_94, var_29, var_99);
        var_106 = df::select(var_94, var_29, var_98);
        var_107 = (var_91 == var_9);
        if (var_107) {
        	var_108 = box_sdf_cuda_func(var_92, var_82);
        	var_109 = df::sub(var_108, var_6);
        	var_110 = box_sdf_grad_cuda_func(var_92, var_82);
        	var_111 = df::spatial_transform_vector(var_80, var_110);
        }
        var_112 = df::select(var_107, var_104, var_111);
        var_113 = df::select(var_107, var_106, var_109);
        var_114 = (var_91 == var_20);
        if (var_114) {
        	var_115 = df::index(var_92, var_8);
        	var_116 = df::index(var_92, var_9);
        	var_117 = capsule_sdf_cuda_func(var_115, var_116, var_82);
        	var_118 = df::sub(var_117, var_6);
        	var_120 = df::leaky_min(var_118, var_29, var_119);
        	var_121 = df::index(var_92, var_8);
        	var_122 = df::index(var_92, var_9);
        	var_123 = capsule_sdf_grad_cuda_func(var_121, var_122, var_82);
        	var_124 = df::spatial_transform_vector(var_80, var_123);
        }
        var_125 = df::select(var_114, var_112, var_124);
        var_126 = df::select(var_114, var_105, var_120);
        var_127 = (var_91 == var_12);
        if (var_127) {
        	var_128 = get_sdf_cuda_func(var_92, var_82, var_geo_sdf, var_0);
        	...
        	var_138 = get_sdf_cuda_func(var_92, var_137, var_geo_sdf, var_0);
        	var_139 = df::sub(var_133, var_132);
        	var_140 = df::float3(var_139, var_134, var_135);
        	var_141 = get_sdf_cuda_func(var_92, var_140, var_geo_sdf, var_0);
        	...
        	var_148 = get_sdf_cuda_func(var_92, var_147, var_geo_sdf, var_0);
        	var_149 = df::sub(var_134, var_132);
        	var_150 = df::float3(var_133, var_149, var_135);
        	var_151 = get_sdf_cuda_func(var_92, var_150, var_geo_sdf, var_0);
        	...
        	var_157 = get_sdf_cuda_func(var_92, var_156, var_geo_sdf, var_0);
        	var_158 = df::sub(var_135, var_132);
        	var_159 = df::float3(var_133, var_134, var_158);
        	var_160 = get_sdf_cuda_func(var_92, var_159, var_geo_sdf, var_0);
...
__global__ void eval_rigid_contacts_art_cuda_kernel_backward(int dim, 
	...
	df::float3* adj_shape_geo_scale,
	float* adj_geo_sdf,
	int* adj_contact_body0,
	int* adj_contact_body1,
	int* adj_contact_shape0,
	int* adj_contact_shape1,
	df::float3* adj_contact_point,
	float* adj_contact_dist,
	int* adj_contact_mat,
	float* adj_materials,
	...
	wrench_matrix* adj_contact_matrix)
{
    ...
    df::float3 adj_62 = 0;
    df::float3 adj_63 = 0;
    spatial_vector adj_64 = 0;
    float adj_65 = 0;
    float adj_66 = 0;
    float adj_67 = 0;
    float adj_68 = 0;
    spatial_transform adj_69 = 0;
    spatial_vector adj_70 = 0;
    df::float3 adj_71 = 0;
    df::float3 adj_72 = 0;
    df::float3 adj_73 = 0;
    df::float3 adj_74 = 0;
    ...
    df::float3 adj_76 = 0;
    df::float3 adj_77 = 0;
    spatial_transform adj_78 = 0;
    spatial_transform adj_79 = 0;
    spatial_transform adj_80 = 0;
    spatial_transform adj_81 = 0;
    df::float3 adj_82 = 0;
    int adj_83 = 0;
    df::float3 adj_84 = 0;
    df::float3 adj_85 = 0;
    ...
    if (var_idx < dim) {
        ...
        if (var_127) {
        	...
        	adj_get_sdf_cuda_func(var_92, var_159, var_geo_sdf, var_0, adj_92, adj_159, adj_geo_sdf, adj_0, adj_160);
        	df::adj_float3(var_133, var_134, var_158, adj_133, adj_134, adj_158, adj_159);
        	df::adj_sub(var_135, var_132, adj_135, adj_132, adj_158);
        	adj_get_sdf_cuda_func(var_92, var_156, var_geo_sdf, var_0, adj_92, adj_156, adj_geo_sdf, adj_0, adj_157);
        	...
        	adj_get_sdf_cuda_func(var_92, var_150, var_geo_sdf, var_0, adj_92, adj_150, adj_geo_sdf, adj_0, adj_151);
        	df::adj_float3(var_133, var_149, var_135, adj_133, adj_149, adj_135, adj_150);
        	df::adj_sub(var_134, var_132, adj_134, adj_132, adj_149);
        	adj_get_sdf_cuda_func(var_92, var_147, var_geo_sdf, var_0, adj_92, adj_147, adj_geo_sdf, adj_0, adj_148);
        	...
        	adj_get_sdf_cuda_func(var_92, var_140, var_geo_sdf, var_0, adj_92, adj_140, adj_geo_sdf, adj_0, adj_141);
        	df::adj_float3(var_139, var_134, var_135, adj_139, adj_134, adj_135, adj_140);
        	df::adj_sub(var_133, var_132, adj_133, adj_132, adj_139);
        	adj_get_sdf_cuda_func(var_92, var_137, var_geo_sdf, var_0, adj_92, adj_137, adj_geo_sdf, adj_0, adj_138);
        	...
        	adj_get_sdf_cuda_func(var_92, var_82, var_geo_sdf, var_0, adj_92, adj_82, adj_geo_sdf, adj_0, adj_128);
        }
        df::adj_select(var_114, var_105, var_120, adj_114, adj_105, adj_120, adj_126);
        df::adj_select(var_114, var_112, var_124, adj_114, adj_112, adj_124, adj_125);
        if (var_114) {
        	df::adj_spatial_transform_vector(var_80, var_123, adj_80, adj_123, adj_124);
        	adj_capsule_sdf_grad_cuda_func(var_121, var_122, var_82, adj_121, adj_122, adj_82, adj_123);
        	df::adj_index(var_92, var_9, adj_92, adj_9, adj_122);
        	df::adj_index(var_92, var_8, adj_92, adj_8, adj_121);
        	df::adj_leaky_min(var_118, var_29, var_119, adj_118, adj_29, adj_119, adj_120);
        	df::adj_sub(var_117, var_6, adj_117, adj_6, adj_118);
        	adj_capsule_sdf_cuda_func(var_115, var_116, var_82, adj_115, adj_116, adj_82, adj_117);
        	df::adj_index(var_92, var_9, adj_92, adj_9, adj_116);
        	df::adj_index(var_92, var_8, adj_92, adj_8, adj_115);
        }
        df::adj_select(var_107, var_106, var_109, adj_107, adj_106, adj_109, adj_113);
        df::adj_select(var_107, var_104, var_111, adj_107, adj_104, adj_111, adj_112);
        if (var_107) {
        	df::adj_spatial_transform_vector(var_80, var_110, adj_80, adj_110, adj_111);
        	adj_box_sdf_grad_cuda_func(var_92, var_82, adj_92, adj_82, adj_110);
        	df::adj_sub(var_108, var_6, adj_108, adj_6, adj_109);
        	adj_box_sdf_cuda_func(var_92, var_82, adj_92, adj_82, adj_108);
        }
        df::adj_select(var_94, var_29, var_98, adj_94, adj_29, adj_98, adj_106);
        df::adj_select(var_94, var_29, var_99, adj_94, adj_29, adj_99, adj_105);
        df::adj_select(var_94, var_93, var_103, adj_94, adj_93, adj_103, adj_104);
        if (var_94) {
        	df::adj_spatial_transform_vector(var_80, var_102, adj_80, adj_102, adj_103);
        	adj_sphere_sdf_grad_cuda_func(var_100, var_101, var_82, adj_100, adj_101, adj_82, adj_102);
        	df::adj_index(var_92, var_8, adj_92, adj_8, adj_101);
        	df::adj_float3(var_29, var_29, var_29, adj_29, adj_29, adj_29, adj_100);
        	df::adj_min(var_98, var_29, adj_98, adj_29, adj_99);
        	df::adj_sub(var_97, var_6, adj_97, adj_6, adj_98);
        	adj_sphere_sdf_cuda_func(var_95, var_96, var_82, adj_95, adj_96, adj_82, adj_97);
        	df::adj_index(var_92, var_8, adj_92, adj_8, adj_96);
        	df::adj_float3(var_29, var_29, var_29, adj_29, adj_29, adj_29, adj_95);
        }
        df::adj_float3(var_29, var_29, var_29, adj_29, adj_29, adj_29, adj_93);
        df::adj_load(var_shape_geo_scale, var_4, adj_shape_geo_scale, adj_4, adj_92);
        df::adj_load(var_shape_geo_type, var_4, adj_shape_geo_type, adj_4, adj_91);
        df::adj_select(var_86, var_85, var_89, adj_86, adj_85, adj_89, adj_90);
        if (var_86) {
        	df::adj_spatial_transform_vector(var_88, var_87, adj_88, adj_87, adj_89);
        	adj_spatial_transform_inverse_cuda_func(var_69, adj_69, adj_88);
        	adj_box_sdf_grad_cuda_func(var_84, var_5, adj_84, adj_5, adj_87);
        }
        df::adj_float3(var_29, var_29, var_29, adj_29, adj_29, adj_29, adj_85);
        df::adj_load(var_shape_geo_scale, var_3, adj_shape_geo_scale, adj_3, adj_84);
        df::adj_load(var_shape_geo_type, var_3, adj_shape_geo_type, adj_3, adj_83);
        df::adj_spatial_transform_point(var_81, var_71, adj_81, adj_71, adj_82);
        adj_spatial_transform_inverse_cuda_func(var_80, adj_80, adj_81);
        df::adj_spatial_transform_multiply(var_78, var_79, adj_78, adj_79, adj_80);
        df::adj_load(var_shape_X_co, var_4, adj_shape_X_co, adj_4, adj_79);
        df::adj_load(var_body_X_s, var_2, adj_body_X_s, adj_2, adj_78);
        df::adj_add(var_73, var_76, adj_73, adj_76, adj_77);
        df::adj_cross(var_72, var_75, adj_72, adj_75, adj_76);
        df::adj_sub(var_71, var_74, adj_71, adj_74, adj_75);
        df::adj_spatial_transform_get_translation(var_69, adj_69, adj_74);
        df::adj_spatial_bottom(var_70, adj_70, adj_73);
        df::adj_spatial_top(var_70, adj_70, adj_72);
        df::adj_spatial_transform_point(var_69, var_5, adj_69, adj_5, adj_71);
        df::adj_load(var_body_v_s, var_1, adj_body_v_s, adj_1, adj_70);
        df::adj_load(var_body_X_s, var_1, adj_body_X_s, adj_1, adj_69);
        df::adj_select(var_11, var_mu, var_26, adj_11, adj_mu, adj_26, adj_68);
        df::adj_select(var_11, var_kf, var_22, adj_11, adj_kf, adj_22, adj_67);
        df::adj_select(var_11, var_kd, var_18, adj_11, adj_kd, adj_18, adj_66);
        df::adj_select(var_11, var_ke, var_15, adj_11, adj_ke, adj_15, adj_65);
        if (var_11) {
        	label0:;
        	df::adj_atomic_add(var_body_f_s, var_1, var_64, adj_body_f_s, adj_1, adj_64);
        	df::adj_spatial_vector(var_63, var_62, adj_63, adj_62, adj_64);
        	df::adj_cross(var_5, var_62, adj_5, adj_62, adj_63);
        	df::adj_add(var_61, var_59, adj_61, adj_59, adj_62);
        	df::adj_mul(var_31, var_60, adj_31, adj_60, adj_61);
        	df::adj_add(var_43, var_47, adj_43, adj_47, adj_60);
        	df::adj_mul(var_57, var_58, adj_57, adj_58, adj_59);
        	df::adj_step(var_39, adj_39, adj_58);
        	df::adj_float3(var_53, var_29, var_56, adj_53, adj_29, adj_56, adj_57);
        	df::adj_clamp(var_55, var_49, var_50, adj_55, adj_49, adj_50, adj_56);
        	df::adj_dot(var_54, var_42, adj_54, adj_42, adj_55);
        	df::adj_float3(var_29, var_29, var_22, adj_29, adj_29, adj_22, adj_54);
        	df::adj_clamp(var_52, var_49, var_50, adj_52, adj_49, adj_50, adj_53);
        	df::adj_dot(var_51, var_42, adj_51, adj_42, adj_52);
        	df::adj_float3(var_22, var_29, var_29, adj_22, adj_29, adj_29, adj_51);
        	df::adj_sub(var_29, var_49, adj_29, adj_49, adj_50);
        	df::adj_mul(var_26, var_48, adj_26, adj_48, adj_49);
        	df::adj_add(var_43, var_47, adj_43, adj_47, adj_48);
        	df::adj_mul(var_45, var_46, adj_45, adj_46, adj_47);
        	df::adj_step(var_39, adj_39, adj_46);
        	df::adj_mul(var_44, var_18, adj_44, adj_18, adj_45);
        	df::adj_min(var_40, var_29, adj_40, adj_29, adj_44);
        	df::adj_mul(var_39, var_15, adj_39, adj_15, adj_43);
        	df::adj_sub(var_36, var_41, adj_36, adj_41, adj_42);
        	df::adj_mul(var_31, var_40, adj_31, adj_40, adj_41);
        	df::adj_dot(var_31, var_36, adj_31, adj_36, adj_40);
        	df::adj_min(var_38, var_29, adj_38, adj_29, adj_39);
        	df::adj_sub(var_37, var_6, adj_37, adj_6, adj_38);
        	df::adj_dot(var_31, var_32, adj_31, adj_32, adj_37);
        	df::adj_add(var_34, var_35, adj_34, adj_35, adj_36);
        	df::adj_cross(var_33, var_32, adj_33, adj_32, adj_35);
        	df::adj_spatial_bottom(var_28, adj_28, adj_34);
        	df::adj_spatial_top(var_28, adj_28, adj_33);
        	df::adj_spatial_transform_point(var_27, var_5, adj_27, adj_5, adj_32);
        	df::adj_float3(var_29, var_30, var_29, adj_29, adj_30, adj_29, adj_31);
        	df::adj_load(var_body_v_s, var_1, adj_body_v_s, adj_1, adj_28);
        	df::adj_load(var_body_X_s, var_1, adj_body_X_s, adj_1, adj_27);
        	df::adj_load(var_materials, var_25, adj_materials, adj_25, adj_26);
        	df::adj_add(var_23, var_24, adj_23, adj_24, adj_25);
        	df::adj_mul(var_7, var_12, adj_7, adj_12, adj_23);
        	df::adj_load(var_materials, var_21, adj_materials, adj_21, adj_22);
        	df::adj_add(var_19, var_20, adj_19, adj_20, adj_21);
        	df::adj_mul(var_7, var_12, adj_7, adj_12, adj_19);
        	df::adj_load(var_materials, var_17, adj_materials, adj_17, adj_18);
        	df::adj_add(var_16, var_9, adj_16, adj_9, adj_17);
        	df::adj_mul(var_7, var_12, adj_7, adj_12, adj_16);
        	df::adj_load(var_materials, var_14, adj_materials, adj_14, adj_15);
        	df::adj_add(var_13, var_8, adj_13, adj_8, adj_14);
        	df::adj_mul(var_7, var_12, adj_7, adj_12, adj_13);
        }
        df::adj_sub(var_8, var_9, adj_8, adj_9, adj_10);
        df::adj_load(var_contact_mat, var_0, adj_contact_mat, adj_0, adj_7);
        df::adj_load(var_contact_dist, var_0, adj_contact_dist, adj_0, adj_6);
        df::adj_load(var_contact_point, var_0, adj_contact_point, adj_0, adj_5);
        df::adj_load(var_contact_shape1, var_0, adj_contact_shape1, adj_0, adj_4);
        df::adj_load(var_contact_shape0, var_0, adj_contact_shape0, adj_0, adj_3);
        df::adj_load(var_contact_body1, var_0, adj_contact_body1, adj_0, adj_2);
        df::adj_load(var_contact_body0, var_0, adj_contact_body0, adj_0, adj_1);
        return;
    }
...
void eval_rigid_contacts_art_cuda_forward(int dim, 
	...
	torch::Tensor var_shape_geo_type,
	torch::Tensor var_shape_geo_scale,
	torch::Tensor var_geo_sdf,
	torch::Tensor var_contact_body0,
	torch::Tensor var_contact_body1,
	torch::Tensor var_contact_shape0,
	torch::Tensor var_contact_shape1,
	torch::Tensor var_contact_point,
	torch::Tensor var_contact_dist,
	torch::Tensor var_contact_mat,
	torch::Tensor var_materials,
	...
	torch::Tensor var_contact_matrix)
{
    eval_rigid_contacts_art_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			...
			cast<int*>(var_shape_geo_type),
			cast<df::float3*>(var_shape_geo_scale),
			cast<float*>(var_geo_sdf),
			cast<int*>(var_contact_body0),
			cast<int*>(var_contact_body1),
			cast<int*>(var_contact_shape0),
			cast<int*>(var_contact_shape1),
			cast<df::float3*>(var_contact_point),
			cast<float*>(var_contact_dist),
			cast<int*>(var_contact_mat),
			cast<float*>(var_materials),
...
void eval_rigid_contacts_art_cuda_backward(int dim, 
	...
	torch::Tensor adj_shape_geo_type,
	torch::Tensor adj_shape_geo_scale,
	torch::Tensor adj_geo_sdf,
	torch::Tensor adj_contact_body0,
	torch::Tensor adj_contact_body1,
	torch::Tensor adj_contact_shape0,
	torch::Tensor adj_contact_shape1,
	torch::Tensor adj_contact_point,
	torch::Tensor adj_contact_dist,
	torch::Tensor adj_contact_mat,
	torch::Tensor adj_materials,
	...
	torch::Tensor adj_contact_matrix)
{
    eval_rigid_contacts_art_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			...
			cast<int*>(adj_shape_geo_type),
			cast<df::float3*>(adj_shape_geo_scale),
			cast<float*>(adj_geo_sdf),
			cast<int*>(adj_contact_body0),
			cast<int*>(adj_contact_body1),
			cast<int*>(adj_contact_shape0),
			cast<int*>(adj_contact_shape1),
			cast<df::float3*>(adj_contact_point),
			cast<float*>(adj_contact_dist),
			cast<int*>(adj_contact_mat),
			cast<float*>(adj_materials),
	...
	float* var_x)
{
    ...
    int var_idx = blockDim.x * blockIdx.x + threadIdx.x;
    if (var_idx < dim) {
        df::dense_solve(var_n, var_A, var_L, var_b, var_x);
	...
	float* adj_x)
{
    ...
    if (var_idx < dim) {
        ...
        //---------
        // reverse
        df::adj_dense_solve(var_n, var_A, var_L, var_b, var_x, adj_n, adj_A, adj_L, adj_b, adj_x);
        return;
    }
	...
	float* var_x)
{
    ...
    int var_idx = blockDim.x * blockIdx.x + threadIdx.x;
    if (var_idx < dim) {
        df::dense_solve_batched(var_b_start, var_A_start, var_A_dim, var_A, var_L, var_b, var_x);
	...
	float* adj_x)
{
    ...
    if (var_idx < dim) {
        ...
        //---------
        // reverse
        df::adj_dense_solve_batched(var_b_start, var_A_start, var_A_dim, var_A, var_L, var_b, var_x, adj_b_start, adj_A_start, adj_A_dim, adj_A, adj_L, adj_b, adj_x);
        return;
    }
	...
	df::float3* var_delta)
{
    ...
    float var_71;
    float var_72;
    const float var_73 = 3.0;
    float var_74;
    mat33 var_75;
    mat33 var_76;
    const float var_77 = 2.0;
    mat33 var_78;
    float var_79;
    float var_80;
    float var_81;
    ...
    if (var_idx < dim) {
        ...
        var_71 = df::sqrt(var_70);
        var_72 = df::mul(var_71, var_71);
        var_74 = df::sub(var_72, var_73);
        var_75 = df::transpose(var_47);
        var_76 = df::mul(var_53, var_75);
        var_78 = df::mul(var_76, var_77);
        var_79 = df::index(var_78, var_3, var_3);
        var_80 = df::index(var_78, var_7, var_3);
        var_81 = df::index(var_78, var_11, var_3);
        var_82 = df::float3(var_79, var_80, var_81);
        var_83 = df::index(var_78, var_3, var_7);
        var_84 = df::index(var_78, var_7, var_7);
        var_85 = df::index(var_78, var_11, var_7);
        var_86 = df::float3(var_83, var_84, var_85);
        var_87 = df::index(var_78, var_3, var_11);
        var_88 = df::index(var_78, var_7, var_11);
        var_89 = df::index(var_78, var_11, var_11);
        var_90 = df::float3(var_87, var_88, var_89);
        var_91 = df::add(var_82, var_86);
        var_92 = df::add(var_91, var_90);
        var_94 = df::sub(var_93, var_51);
        var_95 = df::mul(var_92, var_94);
        var_96 = df::dot(var_95, var_95);
        var_97 = df::mul(var_96, var_36);
        var_98 = df::dot(var_82, var_82);
        var_99 = df::mul(var_98, var_37);
        var_100 = df::add(var_97, var_99);
        var_101 = df::dot(var_86, var_86);
        var_102 = df::mul(var_101, var_38);
        var_103 = df::add(var_100, var_102);
        var_104 = df::dot(var_90, var_90);
        var_105 = df::mul(var_104, var_39);
        var_106 = df::add(var_103, var_105);
        var_107 = df::mul(var_21, var_dt);
        var_108 = df::mul(var_107, var_dt);
        var_109 = df::mul(var_108, var_52);
        var_110 = df::div(var_51, var_109);
        var_111 = df::add(var_106, var_110);
        var_112 = df::div(var_74, var_111);
        var_113 = df::mul(var_95, var_112);
        var_114 = df::mul(var_82, var_112);
        var_115 = df::mul(var_86, var_112);
        var_116 = df::mul(var_90, var_112);
        var_117 = df::determinant(var_53);
        var_118 = df::sub(var_117, var_51);
        var_119 = df::div(var_50, var_49);
        var_120 = df::cross(var_41, var_42);
        var_121 = df::mul(var_120, var_119);
        var_122 = df::cross(var_42, var_40);
        var_123 = df::mul(var_122, var_119);
        var_124 = df::cross(var_40, var_41);
        var_125 = df::mul(var_124, var_119);
        var_126 = df::add(var_121, var_123);
        var_127 = df::add(var_126, var_125);
        var_128 = df::sub(var_93, var_51);
        var_129 = df::mul(var_127, var_128);
        var_130 = df::dot(var_129, var_129);
        var_131 = df::mul(var_130, var_36);
        var_132 = df::dot(var_121, var_121);
        var_133 = df::mul(var_132, var_37);
        var_134 = df::add(var_131, var_133);
        var_135 = df::dot(var_123, var_123);
        var_136 = df::mul(var_135, var_38);
        var_137 = df::add(var_134, var_136);
        var_138 = df::dot(var_125, var_125);
        var_139 = df::mul(var_138, var_39);
        var_140 = df::add(var_137, var_139);
        var_141 = df::mul(var_24, var_dt);
        var_142 = df::mul(var_141, var_dt);
        var_143 = df::mul(var_142, var_52);
        var_144 = df::div(var_51, var_143);
        var_145 = df::add(var_140, var_144);
        var_146 = df::div(var_118, var_145);
        var_147 = df::mul(var_129, var_146);
        var_148 = df::add(var_113, var_147);
        var_149 = df::mul(var_121, var_146);
        var_150 = df::add(var_114, var_149);
        var_151 = df::mul(var_123, var_146);
        var_152 = df::add(var_115, var_151);
        var_153 = df::mul(var_125, var_146);
        var_154 = df::add(var_116, var_153);
        var_155 = df::mul(var_148, var_36);
        var_156 = df::mul(var_155, var_relaxation);
        df::atomic_sub(var_delta, var_5, var_156);
        var_157 = df::mul(var_150, var_37);
        var_158 = df::mul(var_157, var_relaxation);
        df::atomic_sub(var_delta, var_9, var_158);
        var_159 = df::mul(var_152, var_38);
        var_160 = df::mul(var_159, var_relaxation);
        df::atomic_sub(var_delta, var_13, var_160);
        var_161 = df::mul(var_154, var_39);
        var_162 = df::mul(var_161, var_relaxation);
        df::atomic_sub(var_delta, var_17, var_162);
	...
	df::float3* adj_delta)
{
    ...
    if (var_idx < dim) {
        ...
        //---------
        // reverse
        df::adj_atomic_sub(var_delta, var_17, var_162, adj_delta, adj_17, adj_162);
        df::adj_mul(var_161, var_relaxation, adj_161, adj_relaxation, adj_162);
        df::adj_mul(var_154, var_39, adj_154, adj_39, adj_161);
        df::adj_atomic_sub(var_delta, var_13, var_160, adj_delta, adj_13, adj_160);
        df::adj_mul(var_159, var_relaxation, adj_159, adj_relaxation, adj_160);
        df::adj_mul(var_152, var_38, adj_152, adj_38, adj_159);
        df::adj_atomic_sub(var_delta, var_9, var_158, adj_delta, adj_9, adj_158);
        df::adj_mul(var_157, var_relaxation, adj_157, adj_relaxation, adj_158);
        df::adj_mul(var_150, var_37, adj_150, adj_37, adj_157);
        df::adj_atomic_sub(var_delta, var_5, var_156, adj_delta, adj_5, adj_156);
        df::adj_mul(var_155, var_relaxation, adj_155, adj_relaxation, adj_156);
        df::adj_mul(var_148, var_36, adj_148, adj_36, adj_155);
        df::adj_add(var_116, var_153, adj_116, adj_153, adj_154);
        df::adj_mul(var_125, var_146, adj_125, adj_146, adj_153);
        df::adj_add(var_115, var_151, adj_115, adj_151, adj_152);
        df::adj_mul(var_123, var_146, adj_123, adj_146, adj_151);
        df::adj_add(var_114, var_149, adj_114, adj_149, adj_150);
        df::adj_mul(var_121, var_146, adj_121, adj_146, adj_149);
        df::adj_add(var_113, var_147, adj_113, adj_147, adj_148);
        df::adj_mul(var_129, var_146, adj_129, adj_146, adj_147);
        df::adj_div(var_118, var_145, adj_118, adj_145, adj_146);
        df::adj_add(var_140, var_144, adj_140, adj_144, adj_145);
        df::adj_div(var_51, var_143, adj_51, adj_143, adj_144);
        df::adj_mul(var_142, var_52, adj_142, adj_52, adj_143);
        df::adj_mul(var_141, var_dt, adj_141, adj_dt, adj_142);
        df::adj_mul(var_24, var_dt, adj_24, adj_dt, adj_141);
        df::adj_add(var_137, var_139, adj_137, adj_139, adj_140);
        df::adj_mul(var_138, var_39, adj_138, adj_39, adj_139);
        df::adj_dot(var_125, var_125, adj_125, adj_125, adj_138);
        df::adj_add(var_134, var_136, adj_134, adj_136, adj_137);
        df::adj_mul(var_135, var_38, adj_135, adj_38, adj_136);
        df::adj_dot(var_123, var_123, adj_123, adj_123, adj_135);
        df::adj_add(var_131, var_133, adj_131, adj_133, adj_134);
        df::adj_mul(var_132, var_37, adj_132, adj_37, adj_133);
        df::adj_dot(var_121, var_121, adj_121, adj_121, adj_132);
        df::adj_mul(var_130, var_36, adj_130, adj_36, adj_131);
        df::adj_dot(var_129, var_129, adj_129, adj_129, adj_130);
        df::adj_mul(var_127, var_128, adj_127, adj_128, adj_129);
        df::adj_sub(var_93, var_51, adj_93, adj_51, adj_128);
        df::adj_add(var_126, var_125, adj_126, adj_125, adj_127);
        df::adj_add(var_121, var_123, adj_121, adj_123, adj_126);
        df::adj_mul(var_124, var_119, adj_124, adj_119, adj_125);
        df::adj_cross(var_40, var_41, adj_40, adj_41, adj_124);
        df::adj_mul(var_122, var_119, adj_122, adj_119, adj_123);
        df::adj_cross(var_42, var_40, adj_42, adj_40, adj_122);
        df::adj_mul(var_120, var_119, adj_120, adj_119, adj_121);
        df::adj_cross(var_41, var_42, adj_41, adj_42, adj_120);
        df::adj_div(var_50, var_49, adj_50, adj_49, adj_119);
        df::adj_sub(var_117, var_51, adj_117, adj_51, adj_118);
        df::adj_determinant(var_53, adj_53, adj_117);
        df::adj_mul(var_90, var_112, adj_90, adj_112, adj_116);
        df::adj_mul(var_86, var_112, adj_86, adj_112, adj_115);
        df::adj_mul(var_82, var_112, adj_82, adj_112, adj_114);
        df::adj_mul(var_95, var_112, adj_95, adj_112, adj_113);
        df::adj_div(var_74, var_111, adj_74, adj_111, adj_112);
        df::adj_add(var_106, var_110, adj_106, adj_110, adj_111);
        df::adj_div(var_51, var_109, adj_51, adj_109, adj_110);
        df::adj_mul(var_108, var_52, adj_108, adj_52, adj_109);
        df::adj_mul(var_107, var_dt, adj_107, adj_dt, adj_108);
        df::adj_mul(var_21, var_dt, adj_21, adj_dt, adj_107);
        df::adj_add(var_103, var_105, adj_103, adj_105, adj_106);
        df::adj_mul(var_104, var_39, adj_104, adj_39, adj_105);
        df::adj_dot(var_90, var_90, adj_90, adj_90, adj_104);
        df::adj_add(var_100, var_102, adj_100, adj_102, adj_103);
        df::adj_mul(var_101, var_38, adj_101, adj_38, adj_102);
        df::adj_dot(var_86, var_86, adj_86, adj_86, adj_101);
        df::adj_add(var_97, var_99, adj_97, adj_99, adj_100);
        df::adj_mul(var_98, var_37, adj_98, adj_37, adj_99);
        df::adj_dot(var_82, var_82, adj_82, adj_82, adj_98);
        df::adj_mul(var_96, var_36, adj_96, adj_36, adj_97);
        df::adj_dot(var_95, var_95, adj_95, adj_95, adj_96);
        df::adj_mul(var_92, var_94, adj_92, adj_94, adj_95);
        df::adj_sub(var_93, var_51, adj_93, adj_51, adj_94);
        df::adj_add(var_91, var_90, adj_91, adj_90, adj_92);
        df::adj_add(var_82, var_86, adj_82, adj_86, adj_91);
        df::adj_float3(var_87, var_88, var_89, adj_87, adj_88, adj_89, adj_90);
        df::adj_index(var_78, var_11, var_11, adj_78, adj_11, adj_11, adj_89);
        df::adj_index(var_78, var_7, var_11, adj_78, adj_7, adj_11, adj_88);
        df::adj_index(var_78, var_3, var_11, adj_78, adj_3, adj_11, adj_87);
        df::adj_float3(var_83, var_84, var_85, adj_83, adj_84, adj_85, adj_86);
        df::adj_index(var_78, var_11, var_7, adj_78, adj_11, adj_7, adj_85);
        df::adj_index(var_78, var_7, var_7, adj_78, adj_7, adj_7, adj_84);
        df::adj_index(var_78, var_3, var_7, adj_78, adj_3, adj_7, adj_83);
        df::adj_float3(var_79, var_80, var_81, adj_79, adj_80, adj_81, adj_82);
        df::adj_index(var_78, var_11, var_3, adj_78, adj_11, adj_3, adj_81);
        df::adj_index(var_78, var_7, var_3, adj_78, adj_7, adj_3, adj_80);
        df::adj_index(var_78, var_3, var_3, adj_78, adj_3, adj_3, adj_79);
        df::adj_mul(var_76, var_77, adj_76, adj_77, adj_78);
        df::adj_mul(var_53, var_75, adj_53, adj_75, adj_76);
        df::adj_transpose(var_47, adj_47, adj_75);
        df::adj_sub(var_72, var_73, adj_72, adj_73, adj_74);
        df::adj_mul(var_71, var_71, adj_71, adj_71, adj_72);
        df::adj_sqrt(var_70, adj_70, adj_71);
...
__global__ void _cross_kernel_cuda_kernel_forward(int dim, 
	df::float3* var_u,
	df::float3* var_v,
	df::float3* var_out)
{
    ...
    if (var_idx < dim) {
        var_0 = df::tid();
        var_1 = df::load(var_u, var_0);
        var_2 = df::load(var_v, var_0);
        var_3 = df::cross(var_1, var_2);
        var_5 = (var_0 == var_4);
        if (var_5) {
        	df::print(var_1);
        	df::print(var_2);
        ...
        df::store(var_out, var_0, var_3);
        
    }

}

__global__ void _cross_kernel_cuda_kernel_backward(int dim, 
	df::float3* var_u,
	df::float3* var_v,
	df::float3* var_out, 
	df::float3* adj_u,
	...
	df::float3* adj_out)
{
    ...
    if (var_idx < dim) {
        ...
        //---------
        // reverse
        df::adj_store(var_out, var_0, var_3, adj_out, adj_0, adj_3);
        if (var_5) {
        	df::adj_print(var_3, adj_3);
        	df::adj_print(var_2, adj_2);
        	df::adj_print(var_1, adj_1);
        }
        df::adj_cross(var_1, var_2, adj_1, adj_2, adj_3);
        df::adj_load(var_v, var_0, adj_v, adj_0, adj_2);
        df::adj_load(var_u, var_0, adj_u, adj_0, adj_1);
        return;
    }
...
// Python entry points
void _cross_kernel_cuda_forward(int dim, 
	torch::Tensor var_u,
	torch::Tensor var_v,
	torch::Tensor var_out)
{
    _cross_kernel_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_u),
			cast<df::float3*>(var_v),
			cast<df::float3*>(var_out));

    //check_cuda(cudaPeekAtLastError());
    //check_cuda(cudaDeviceSynchronize());
}

void _cross_kernel_cuda_backward(int dim, 
	torch::Tensor var_u,
	torch::Tensor var_v,
	torch::Tensor var_out, 
	torch::Tensor adj_u,
	torch::Tensor adj_v,
	torch::Tensor adj_out)
{
    _cross_kernel_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<df::float3*>(var_u),
			cast<df::float3*>(var_v),
			cast<df::float3*>(var_out), 
			cast<df::float3*>(adj_u),
			cast<df::float3*>(adj_v),
			cast<df::float3*>(adj_out));
...
__global__ void _abs_kernel_cuda_kernel_forward(int dim, 
	float* var_u,
	float* var_out)
{
        //---------
    ...
    if (var_idx < dim) {
        ...
        var_1 = df::load(var_u, var_0);
        var_2 = df::abs(var_1);
        df::store(var_out, var_0, var_2);
        
    }

}

__global__ void _abs_kernel_cuda_kernel_backward(int dim, 
	float* var_u,
	float* var_out, 
	float* adj_u,
	float* adj_out)
{
    ...
    if (var_idx < dim) {
        ...
        //---------
        // reverse
        df::adj_store(var_out, var_0, var_2, adj_out, adj_0, adj_2);
        df::adj_abs(var_1, adj_1, adj_2);
        df::adj_load(var_u, var_0, adj_u, adj_0, adj_1);
        return;
    }
...
// Python entry points
void _abs_kernel_cuda_forward(int dim, 
	torch::Tensor var_u,
	torch::Tensor var_out)
{
    _abs_kernel_cuda_kernel_forward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<float*>(var_u),
			cast<float*>(var_out));
...
void _abs_kernel_cuda_backward(int dim, 
	torch::Tensor var_u,
	torch::Tensor var_out, 
	torch::Tensor adj_u,
	torch::Tensor adj_out)
{
    _abs_kernel_cuda_kernel_backward<<<(dim + 256 - 1) / 256, 256>>>(dim, 
			cast<float*>(var_u),
			cast<float*>(var_out), 
			cast<float*>(adj_u),
			cast<float*>(adj_out));
