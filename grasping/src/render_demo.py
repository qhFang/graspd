...
class REF():
    ...
    def run(self, initial_guess):
        ...
        refs = np.loadtxt(f'/apdcephfs/share_1330077/qihangfang/Data/ibs/{self.obj_name}/target_pose_fc.txt')
        ...
        for ii in range(len(refs)):
            ...
            try:
                os.makedirs(f'/apdcephfs/share_1330077/qihangfang/network/rlisolocaldemo/{self.obj_name}')
            except OSError:
                pass


            path = os.path.join(f'/apdcephfs/share_1330077/qihangfang/network/rlisolocaldemo/{self.obj_name}/post_{ii}.obj')                
