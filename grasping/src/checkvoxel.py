...
class REF():
    ...
    def run(self, initial_guess):
        ...
        refs = np.loadtxt(f'/apdcephfs/share_1330077/qihangfang/network2/rlvoxel/{self.obj_name}.txt')[:100]
        ...
        for ii in range(100):
            ...
            try:
                os.makedirs(f'/apdcephfs/share_1330077/qihangfang/network2/rlvoxel/{self.obj_name}')
            except OSError:
                pass


            path = os.path.join(f'/apdcephfs/share_1330077/qihangfang/network2/rlvoxel/{self.obj_name}/post_{ii}.obj')                
            ...
            #print('------------')
        f = open('/apdcephfs/share_1330077/qihangfang/baselines/results_rlvoxel', 'a')
        ...
        f.write(out_str)
        f.close()
        np.save(f'/apdcephfs/share_1330077/qihangfang/network2/rlvoxel/{self.obj_name}_pene.txt', np.array(self.pene_list))
