...
class REF():
    ...
    def run(self, initial_guess):
        ...
        refs = np.loadtxt(f'/apdcephfs/share_1330077/qihangfang/network/rldagger/{self.obj_name}.txt')[:100]
        ...
        for ii in range(100):
            ...
            for optim in range(200):
                ...
                pene_list.append(state.contact_world_dist[self.box_contact_inds].min().item())
            ...
            try:
                os.makedirs(f'/apdcephfs/share_1330077/qihangfang/network/rldagger/{self.obj_name}')
            except OSError:
                pass


            path = os.path.join(f'/apdcephfs/share_1330077/qihangfang/network/rldagger/{self.obj_name}/post_{ii}.obj')                
            ...
            #print('------------')
        f = open('/apdcephfs/share_1330077/qihangfang/baselines/results_rldagger', 'a')
