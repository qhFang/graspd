...
class REF():
    ...
    def run(self, initial_guess):
        ...
        for ii in range(100):
            ...
            try:
                os.makedirs(f'/apdcephfs/share_1330077/qihangfang/network2/rlibs/{self.obj_name}')
            except OSError:
                pass

            path = os.path.join(f'/apdcephfs/share_1330077/qihangfang/network2/rlibs/{self.obj_name}/post_{ii}.obj')                
            ...
            #print('------------')
        f = open('/apdcephfs/share_1330077/qihangfang/baselines/results_ibs', 'a')
